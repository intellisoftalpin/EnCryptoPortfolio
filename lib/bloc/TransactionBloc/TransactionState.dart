...
class TransactionState extends Equatable {
  ...
  List<WalletModel>? listTrastWallet, int? transactionId]) {
    this.coinId = coinId;
  ...
  TransactionState copyWith(
      TransactionStatus status, [List<TransactionEntity>? transactionById, List<TransactionEntity>? transaction, List<CurrentPrice>? coinId, List<double>? walletCoin,
        List<WalletModel>? listTrastWallet, int? transactionId]) {
    return TransactionState(status, transactionById, transaction, coinId, walletCoin, listTrastWallet, transactionId );
  }
