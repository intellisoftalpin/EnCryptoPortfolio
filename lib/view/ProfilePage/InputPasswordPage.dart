...
class InputPasswordPageState extends State<InputPasswordPage> {
  ...
  bool passVisible() {
    ...
    if (globals.nameProfile.isEmpty || globals.nameProfile == '' && widget.profileExist.isNotEmpty) {
    ...
    print("passVisible _name = $_name, _nameId = $_nameId onSelect = $onSelect");
    pref = box.read(_name + _nameId);
    if (pref == 0) {
      ...
      print('PROFILE CHECK::::::${createTimeCheck(profileCreateDate!, profileEnterDate!)}');
                              ...
                              child: RawMaterialButton(
                                onPressed: () async {
                                  ...
                                  if (isAuthenticated) {
                                    ...
                                    print("!!!NAME:::::${globals.nameProfile}!!!PASS:::::${globals.pass}!!!");
  ...
  Widget build(BuildContext context) {
    ...
    if (MediaQuery.of(context).viewInsets.bottom != 0.0 && MediaQuery.of(context).size.height < 700) {
      keyBoardOpened = true;
    } else {
    ...
    print("!!!! _name!!!! = $_name, nameProfile = $nameProfile _nameId = $_nameId, passIsEmpty = $passIsEmpty");
                  ...
                  child: Material(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () async {
                          ...
                          if(passwordControllerAuth.text.isEmpty || passwordControllerAuth.text == '') {
                            passIsEmpty = true;
                          } else {
                            passIsEmpty = false;
                          }
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: StreamBuilder(
                          ...
                          builder: (context, snapshot) {
                            return Container(
                                margin: EdgeInsets.only(top: !keyBoardOpened ? 40 : 10),
                                child: TextFormField(
                                  keyboardType: TextInputType.text,
        ...
        child: Column(
          ...
          children: <Widget>[
            Stack(children: [
                                ...
                                Padding(
                                  ...
                                  child: PopupMenuButton<ProfileModel>(
                                    icon: Icon(Icons.arrow_drop_down,
                                        color: Theme.of(context).focusColor),
                                    itemBuilder: (context) {
                                      return widget.profileExist.map((item) {
                                    ...
                                    onSelected: (item) {
                                      setState(() {
                                        ...
                                        passIsEmpty = false;
                                        int pref = box.read(_name + _nameId);
                                        print("press pref = $pref,  _name = $_name , _nameId = $_nameId onSelect = $onSelect,"
              ...
              Container(
                height: 110.0,
                margin: EdgeInsets.only(top: !keyBoardOpened ? 40.0 : 10.0 , left: 10.0),
    ...
    if (pref == 0) {
      if (createTimeCheck(profileCreateDate!, profileEnterDate!)) {
        if (fingerPass == false) {
         // WidgetsBinding.instance.addPostFrameCallback((_) async {
         //   final isAuthenticated = await LocalAuthApi.authenticate();
         //   final biometric = await LocalAuthApi.availableBiometric();
         //   if (isAuthenticated) {
              setState(() {
                fingerPass = true;
                passRemember = SizedBox.shrink();
