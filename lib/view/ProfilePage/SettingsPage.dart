...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void loadStringLocaleShPref() async {
    ...
    setState(() {
      _stringLocaleShPref =
          (prefs.getString('stringLocaleShPref') ?? 'language');
    });
  }
  ...
  void setStringLocaleShPref(String language) async {
    ...
    setState(() {
      ...
      prefs.setString('stringLocaleShPref', _stringLocaleShPref);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (_stringLocaleShPref == 'language') {
      if (widget.systemAppLanguage.toString().contains('ru')) {
                                      ...
                                      onSelected: (value) {
                                        if (value == 1) {
                                          setState(() {
                                            ...
                                            setStringLocaleShPref('English');
                                          });
                                        }
                                        if (value == 2) {
                                          setState(() {
                                            context.setLocale(Locale('ru'));
                                            setStringLocaleShPref('Русский');
                                          });
                                        }
                                        if (value == 3) {
                                          setState(() {
                                            context.setLocale(Locale(
                                                widget.systemAppLanguage));
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                LocaleKeys.auto_del_prev_backup
                                                    .tr(),
                                                maxLines: 2,
                                                style: TextStyle(
                                                  fontSize: 13.0,
