...
class AddCoinPageState extends State<AddCoinPage> {
  ...
  List<CoinModel> coinListView = [];
  List<CoinModel> coinListNew = [];
  List<Tokens> cardanoListNew = [];
  List<Tokens> cardanoListView = [];
            ...
            body: BlocBuilder<AddCoinBloc, AddCoinState>(
              ...
              switch (state.state) {
                ...
                case AddCoinStatus.update:
                  ...
                  print("::::::: internet =  $internet , coinListViewUpdate =  $listCoinView");
                  if (searchPressed) {
  ...
  Widget getListCardano(int index, AddCoinState state) {
    String cardanoPrice;
    var price = state.listCoin![index].price;
    (state.listCoin![index].price) != null
        ? cardanoPrice = price!.toString()
        : cardanoPrice = "0.0";
    return Card(
      ...
      child: ListTile(
          ...
          onTap: () {
            print("!! add coinPAge !! coinId: state.listCoin![index].image, = ${state.listCoin![index].image}");
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => DetailsPage(coinEntity, cardanoPrice)));
  ...
  Widget build(BuildContext context) {
    ...
    return RawKeyboardListener(
      ...
      onKey: (event) {
        ...
        print('!!!!!isKeyDown = $isKeyUp - $key - ${event.runtimeType}');
        print("!!!!!!!!event = $event");
