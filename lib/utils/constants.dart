...
const BigTextSize = 45.0;
const LargeTextSize = 30.0;
const MediumTextSize = 24.0;
const MediumBodyTextSize = 20.0;
const MinTextSize = 14.0;
const TinyTextSize = 8.0;
const ErrorTextSize = 14.0;
const LightTextSize = 18.0;
const PrivacyTextSize = 18.0;
const MediumPriceTextSize = 18.0;
...
TextStyle kAppBarTextStyle(BuildContext context, bool isScreenSmall) {
  TextStyle kAppBarTextStyle = TextStyle(
    fontSize: isScreenSmall ? 20.0 : MediumTextSize,
